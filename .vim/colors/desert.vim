...
hi Visual   cterm=underline ctermbg=none ctermfg=cyan gui=none guifg=khaki guibg=olivedrab
"hi VisualNOS   
...
hi Comment  ctermfg=brown guifg=SkyBlue
hi Constant     ctermfg=cyan guifg=#ffa0a0
hi Identifier   ctermfg=darkgreen cterm=none guifg=none
hi Statement    ctermfg=darkblue guifg=khaki
